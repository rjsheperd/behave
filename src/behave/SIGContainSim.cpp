...
//------------------------------------------------------------------------------
/*! \brief SIGContainSim custom constructor.

    SIGContainSim contains all the information to make a complete simulation run,
    ...
    m_maxFireTime(maxFireTime)
{
    ...
    // Create the left flank
	  m_left = new SIGContain( reportSize, reportRate,
...
//------------------------------------------------------------------------------
/*! \brief SIGContainSim destructor.
 */

SIGContainSim::~SIGContainSim( void )
{
...
double SIGContainSim::attackDistance( void ) const
{
...
double SIGContainSim::attackPointX( void ) const
{
...
double SIGContainSim::attackPointY( void ) const
{
...
double SIGContainSim::attackTime( void ) const
{
...
void SIGContainSim::checkmem( const char* fileName, int lineNumber, void* ptr,
...
double SIGContainSim::distanceStep( void ) const
{
...
double SIGContainSim::finalFireCost( void ) const
{
    return( m_finalCost );
}
...
double SIGContainSim::finalFireLine( void ) const
{
    return( m_finalLine );
}
...
double SIGContainSim::finalFirePerimeter( void ) const
{
    return( m_finalPerim );
}
...
double SIGContainSim::finalFireSize( void ) const
{
    return( m_finalSize );
}
...
double SIGContainSim::finalFireSweep( void ) const
{
    return( m_finalSweep );
}
...
double SIGContainSim::finalFireTime( void ) const
{
    return( m_finalTime );
}
...
int SIGContainSim::finalResourcesUsed( void ) const
{
    return( m_used );
}
...
void SIGContainSim::finalStats( void )
{
    // Final time
...
double SIGContainSim::fireBackAtAttack( void ) const
{
...
double SIGContainSim::fireBackAtReport( void ) const
{
...
double SIGContainSim::fireHeadAtAttack( void ) const
{
...
double SIGContainSim::fireHeadAtReport( void ) const
{
...
double* SIGContainSim::fireHeadX( void ) const
{
    return( m_h );
}
...
double SIGContainSim::fireLwRatioAtReport( void ) const
{
...
double* SIGContainSim::firePerimeterX( void ) const
{
    return( m_x );
}
...
double* SIGContainSim::firePerimeterY( void ) const
{
    return( m_y );
}
...
int SIGContainSim::firePoints( void ) const
{
    return( m_size );
}
...
double SIGContainSim::fireReportTime( void ) const
{
...
double SIGContainSim::fireSpreadRateAtBack( void ) const
{
...
double SIGContainSim::fireSizeAtReport( void ) const
{
...
double SIGContainSim::fireSpreadRateAtReport( void ) const
{
...
SIGContainForce* SIGContainSim::force( void ) const
{
    return( m_left->force() );
}
...
int SIGContainSim::maximumSimulationSteps( void ) const
{
    return( m_maxSteps );
}
...
int SIGContainSim::minimumSimulationSteps( void ) const
{
    return( m_minSteps );
}
...
//                iLeft, m_u[iLeft], m_h[iLeft], elapsed );
        ...
        //Add check for maximum Area
                ...
                m_left->m_status = SizeLimitExceeded;
        }
        ...
        {     m_left->m_currentTime=m_maxFireTime;
          m_left->m_status = TimeLimitExceeded;
...
ContainStatus SIGContainSim::status( void ) const
{
...
ContainTactic SIGContainSim::tactic( void ) const
{
    return( m_left->tactic() );
}

// Calculate the size of the uncontained portion of the fire ellipse  by DT 1/2013
double SIGContainSim::UncontainedArea( double head, double lwRatio, double x, double y, ContainTactic tactic )
{
    if( lwRatio < 1.0 ) { lwRatio = 1.00000001; }
