...
/*! \file SIGContain.h
    ...
    2   The SIGContainForce Class is the collection of all ContainResources
...
#ifndef _SIGCONTAIN_H_INCLUDED_
#define _SIGCONTAIN_H_INCLUDED_
...
public:
    ...
    static const char * printStatus(ContainStatus );
...
private:
    ...
    void    containLog( bool dolog, const char *fmt, ... ) const ;
    ...
    void    setAttack( ContainFlank flank, SIGContainForce *force,
    ...
    SIGDiurnalROS * m_diurnalSpreadRate; // hourly ROS
...
protected:
    ...
    SIGContainForce *m_force;  //!< Ptr to collection of containment rersources
